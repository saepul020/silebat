...
urlpatterns = [
    ...
    path('barang-laboratorium/label/bulk/', master_view_guard(views.bulk_label_barang_laboratorium), name='bulk_label_barang_laboratorium'),
    path('barang-laboratorium/<int:pk>/label/', master_view_guard(views.label_barang_laboratorium), name='label_barang_laboratorium'),
    ...
    path('fasilitas-ruangan/label/bulk/', master_view_guard(views.bulk_label_fasilitas_ruangan), name='bulk_label_fasilitas_ruangan'),
    path('fasilitas-ruangan/<int:pk>/label/', master_view_guard(views.label_fasilitas_ruangan), name='label_fasilitas_ruangan'),
    ...
    path('peralatan-laboratorium/label/bulk/', master_view_guard(views.bulk_label_peralatan_laboratorium), name='bulk_label_peralatan_laboratorium'),
    path('peralatan-laboratorium/<int:pk>/label/', master_view_guard(views.label_peralatan_laboratorium), name='label_peralatan_laboratorium'),
