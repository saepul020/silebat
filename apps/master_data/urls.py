...
urlpatterns = [
    ...
    path('barang-laboratorium/export/', master_data_guard(views.export_barang_laboratorium), name='export_barang_laboratorium'),
    ...
    path('barang-penunjang/export/', master_data_guard(views.export_barang_penunjang), name='export_barang_penunjang'),
    ...
    path('bahan-operasional/export/', master_data_guard(views.export_bahan_operasional), name='export_bahan_operasional'),
    ...
    path('fasilitas-ruangan/export/', master_data_guard(views.export_fasilitas_ruangan), name='export_fasilitas_ruangan'),
    ...
    path('peralatan-laboratorium/export/', master_data_guard(views.export_peralatan_laboratorium), name='export_peralatan_laboratorium'),
